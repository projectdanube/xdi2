...
public interface EndpointServletInterceptor extends Interceptor {
	 ...
	 * @return True, if the request has been fully handled.
	 */
	public boolean processPostRequest(EndpointServlet endpointServlet, HttpServletRequest request, HttpServletResponse response, String requestPath, MessagingTarget messagingTarget) throws ServletException, IOException;

	/**
	 * Run when the endpoint servlet receives a PUT request.
	 * @return True, if the request has been fully handled.
	 */
	public boolean processPutRequest(EndpointServlet endpointServlet, HttpServletRequest request, HttpServletResponse response, String requestPath, MessagingTarget messagingTarget) throws ServletException, IOException;

	/**
	 * Run when the endpoint servlet receives a DELETE request.
	 * @return True, if the request has been fully handled.
	 */
	public boolean processDeleteRequest(EndpointServlet endpointServlet, HttpServletRequest request, HttpServletResponse response, String requestPath, MessagingTarget messagingTarget) throws ServletException, IOException;
}
