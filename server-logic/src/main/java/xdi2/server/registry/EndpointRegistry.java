...
public class EndpointRegistry {
	...
	public synchronized void loadApplicationContext(ApplicationContext applicationContext) {
		...
		log.info("Done. " + this.messagingTargets.size() + " messaging targets and " + this.messagingTargetFactorysByPath.size() + " messaging target factories mounted.");
	}
	 ...
	 */
	public synchronized void mountMessagingTarget(String messagingTargetPath, MessagingTarget messagingTarget) {
	 ...
	 */
	public synchronized void mountMessagingTargetFactory(String messagingTargetFactoryPath, MessagingTargetFactory messagingTargetFactory) {
