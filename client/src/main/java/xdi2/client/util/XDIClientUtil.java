...
public class XDIClientUtil {
	...
	public static void authenticateSecretToken(CloudNumber cloudNumber, String xdiEndpointUri, String secretToken) throws Xdi2ClientException {
	...
	private static PrivateKey retrievePrivateKey(CloudNumber cloudNumber, String xdiEndpointUri, String secretToken, XDIAddress privateKeyRelativeAddress) throws Xdi2ClientException, GeneralSecurityException {
		...
		XDIAddress privateKeyAddress = AddressUtil.concatAddresses(cloudNumber.getAddress(), privateKeyRelativeAddress);
