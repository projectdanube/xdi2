 ...
 */
public class AESAgentSecretKeySignatureValidator extends AESSecretKeySignatureValidator {

	private static Logger log = LoggerFactory.getLogger(AESAgentSecretKeySignatureValidator.class.getName());

	private XDIAgent xdiAgent;

	public AESAgentSecretKeySignatureValidator(XDIAgent xdiAgent) {
	...
	public AESAgentSecretKeySignatureValidator() {
