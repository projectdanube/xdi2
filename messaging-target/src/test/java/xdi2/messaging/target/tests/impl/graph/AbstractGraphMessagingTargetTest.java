...
public abstract class AbstractGraphMessagingTargetTest extends TestCase {
	...
	public void testMessageEnvelope() throws Exception {
		...
		Graph resultGraph2 = graphMessagingTarget.execute(messageEnvelope2).getResultGraph();
			...
			try {
				...
				while (true) {
					...
					try {
						...
						resultGraph = graphMessagingTarget.execute(messageEnvelope).getResultGraph();
					} finally {
