package xdi2.messaging.target.interceptor.impl.security.signature;
 ...
 */
public class SignatureInterceptor extends AbstractInterceptor<MessagingTarget> implements MessageInterceptor, Prototype<SignatureInterceptor> {
