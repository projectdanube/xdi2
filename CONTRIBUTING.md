XDI2 Individual Contributor License Agreement
=============================================

Based on Harmony (HA-CLA-I-ANY) Version 1.0.

Thank you for your interest in contributing to XDI2, an open-source project maintained by Danube Tech GmbH ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by email, following the instructions at https://xdi2.org/license.html. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
