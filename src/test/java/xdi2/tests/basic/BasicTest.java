...
public abstract class BasicTest extends TestCase {
	...
	public void testReadJson() throws Exception {
		...
		reader.read(graph3, new FileReader("test.json"), null);
		testGraph(graph3);
	}
	...
	private static void testGraph(Graph graph) throws Exception {
		...
		assertTrue(abcPassportV2ContextNode.containsRelation(new XRI3SubSegment("$")));
		...
		assertTrue(abcPassportContextNode.containsRelation(new XRI3SubSegment("$v")));
		assertTrue(abcPassportContextNode.containsRelation(new XRI3SubSegment("*1")));
		assertTrue(abcPassportContextNode.containsRelation(new XRI3SubSegment("*2")));
	...
	private static void testManipulatedGraph(Graph graph) throws Exception {
		...
		assertTrue(abcPassportContextNode.containsRelation(new XRI3SubSegment("$v")));
		assertTrue(abcPassportContextNode.containsRelation(new XRI3SubSegment("*1")));
		assertFalse(abcPassportContextNode.containsRelation(new XRI3SubSegment("*2")));		// MANIPULATED
