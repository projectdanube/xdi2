...
public class HttpMessagingTargetRegistry implements MessagingTargetRegistry, MessagingTargetFactoryRegistry, ApplicationContextAware {
	 ...
	 */
	public synchronized MessagingTargetMount mountMessagingTarget(String messagingTargetPath, MessagingTarget messagingTarget) throws Xdi2TransportException {
		...
		if (this.messagingTargetMounts.containsKey(messagingTargetPath)) {
			...
			throw new Xdi2TransportException("Messaging target " + this.messagingTargetMounts.get(messagingTargetPath).getMessagingTarget().getClass().getCanonicalName() + " already mounted at path " + messagingTargetPath + ".");
		}
		...
		try {
			...
			throw new Xdi2TransportException("Exception while initializing messaging target " + messagingTarget.getClass().getCanonicalName() + ": " + ex.getMessage(), ex);
		}
	 ...
	 */
	public synchronized MessagingTargetFactoryMount mountMessagingTargetFactory(String messagingTargetFactoryPath, MessagingTargetFactory messagingTargetFactory) throws Xdi2TransportException {
		...
		if (this.messagingTargetFactoryMounts.containsKey(messagingTargetFactoryPath)) {
			...
			throw new Xdi2TransportException("Messaging target factory " + this.messagingTargetFactoryMounts.get(messagingTargetFactoryPath).getClass().getCanonicalName() + " already mounted at path " + messagingTargetFactoryPath + ".");
		}
		...
		try {
			...
			throw new Xdi2TransportException("Exception while initializing messaging target factory " + messagingTargetFactory.getClass().getCanonicalName() + ": " + ex.getMessage(), ex);
		}
	...
	public synchronized MessagingTargetMount lookup(String requestPath) throws Xdi2TransportException, Xdi2MessagingException {
