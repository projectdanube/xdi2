...
public class InnerRootsTest extends TestCase {
	...
	public void testInnerRootXris() throws Exception {
		...
		assertFalse(XdiInnerRoot.isInnerRootXri(XDI3SubSegment.create("()")));
		assertFalse(XdiInnerRoot.isInnerRootXri(XDI3SubSegment.create("(=!1111!23)")));
		assertTrue(XdiInnerRoot.isInnerRootXri(XDI3SubSegment.create("(=a*b/+c*d)")));
