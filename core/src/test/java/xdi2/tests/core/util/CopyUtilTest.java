...
public class CopyUtilTest extends TestCase {
	...
	public void testCopyUtil() throws Exception {
		...
		graph.createStatement(XDI3Statement.create("=markus<+email>&/&/\"markus.sabadello@gmail.com\""));
		graph.createStatement(XDI3Statement.create("=markus/+friend/=neustar=animesh"));
		graph.createStatement(XDI3Statement.create("=neustar=animesh<+email>&/&/\"animesh@gmail.com\""));
