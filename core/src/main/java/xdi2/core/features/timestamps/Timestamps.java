...
public class Timestamps {
	...
	public static Date getContextNodeTimestamp(ContextNode contextNode) {
		...
		XdiAttribute xdiAttribute = XdiAbstractContext.fromContextNode(contextNode).getXdiAttributeSingleton(XdiAttributeSingleton.createArcXri(XDITimestampsConstants.XRI_SS_T), false);
	...
	public static void setContextNodeTimestamp(ContextNode contextNode, Date timestamp) {
		...
		XdiAttribute xdiAttribute = XdiAbstractContext.fromContextNode(contextNode).getXdiAttributeSingleton(XdiAttributeSingleton.createArcXri(XDITimestampsConstants.XRI_SS_T), true);
