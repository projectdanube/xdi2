...
public final class XdiPeerRoot extends XdiAbstractRoot {
	...
	public static boolean isValid(ContextNode contextNode) {
		...
		return 
				isPeerRootArc(contextNode.getArc()) &&
	...
	public XDIAddress getAddressOfPeerRoot() {

		return getAddressOfPeerRootArc(this.getContextNode().getArc());
	}
	 ...
	 */
	public static XDIArc createPeerRootArc(XDIAddress address) {
	 ...
	 */
	public static XDIAddress getAddressOfPeerRootArc(XDIArc arc) {
	 ...
	 */
	public static String getIriOfPeerRootArc(XDIArc arc) {
	 ...
	 */
	public static String getLiteralOfPeerRootArc(XDIArc arc) {
	 ...
	 */
	public static boolean isPeerRootArc(XDIArc arc) {

		return getAddressOfPeerRootArc(arc) != null || getIriOfPeerRootArc(arc) != null || getLiteralOfPeerRootArc(arc) != null;
	}
