...
public abstract class AbstractMultiplicitySingleton extends AbstractMultiplicityContextNode {

	private static final long serialVersionUID = 1377511104706518740L;

	protected AbstractMultiplicitySingleton(ContextNode contextNode) {
