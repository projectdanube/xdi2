...
public class IsCondition extends Condition {
	...
	public static boolean isValid(XDIStatement statement) {
		...
		if (! XDIPolicyConstants.XDI_ADD_IS.equals(statement.getRelationXDIAddress())) return false;
	...
	public Boolean evaluateInternal(PolicyEvaluationContext policyEvaluationContext) {
		...
		XDIAddress subject = policyEvaluationContext.resolveXDIAddress(this.getStatementXri().getSubject());
		XDIAddress object = policyEvaluationContext.resolveXDIAddress((XDIAddress) this.getStatementXri().getObject());
