 ...
 * @author markus
 */
public final class XdiEntity extends XdiSubGraph {
	...
	public static XdiEntity fromContextNode(ContextNode contextNode) {
		...
		return new XdiEntity(contextNode);
	}
	...
	public static class MappingContextNodeXdiMemberIterator extends NotNullIterator<XdiEntity> {
		...
		public MappingContextNodeXdiMemberIterator(Iterator<ContextNode> contextNodes) {
			...
			super(new MappingIterator<ContextNode, XdiEntity> (contextNodes) {
				...
				public XdiEntity map(ContextNode contextNode) {
					...
					return XdiEntity.fromContextNode(contextNode);
				}
			});
		}
	}
