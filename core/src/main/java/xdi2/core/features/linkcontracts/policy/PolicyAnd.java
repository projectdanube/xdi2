...
public class PolicyAnd extends Policy {
	...
	public static boolean isValid(XdiEntity xdiEntity) {
		...
		if (xdiEntity instanceof XdiEntitySingleton)
			...
			return ((XdiEntityInstanceUnordered) xdiEntity).getXdiClass().getBaseArcXri().equals(XDIPolicyConstants.XRI_SS_AND);
		else if (xdiEntity instanceof XdiEntityInstanceOrdered)
			return ((XdiEntityInstanceOrdered) xdiEntity).getXdiClass().getBaseArcXri().equals(XDIPolicyConstants.XRI_SS_AND);
