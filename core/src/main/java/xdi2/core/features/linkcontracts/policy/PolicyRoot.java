...
public final class PolicyRoot extends Policy {
	...
	public static boolean isValid(XdiEntity xdiEntity) {
		...
		if (xdiEntity instanceof XdiEntitySingleton)
			return ((XdiEntitySingleton) xdiEntity).getBasearc().equals(XDIPolicyConstants.XDI_ARC_IF);
		else if (xdiEntity instanceof XdiEntityMemberUnordered)
			return ((XdiEntityMemberUnordered) xdiEntity).getXdiCollection().getBasearc().equals(XDIPolicyConstants.XDI_ARC_IF);
		else if (xdiEntity instanceof XdiEntityMemberOrdered)
			return ((XdiEntityMemberOrdered) xdiEntity).getXdiCollection().getBasearc().equals(XDIPolicyConstants.XDI_ARC_IF);
