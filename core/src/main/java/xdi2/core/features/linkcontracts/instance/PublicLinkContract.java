...
public class PublicLinkContract extends GenericLinkContract {
	...
	public static XDIAddress createPublicLinkContractXDIAddress(XDIAddress ownerXri) {

		return GenericLinkContract.createGenericLinkContractXDIAddress(ownerXri, XDILinkContractConstants.XDI_ADD_PUBLIC, null);
	}
	...
	public static PublicLinkContract findPublicLinkContract(Graph graph, boolean create) {
		...
		GenericLinkContract genericLinkContract = GenericLinkContract.findGenericLinkContract(graph, ownerXDIAddress, XDILinkContractConstants.XDI_ADD_PUBLIC, null, true);
