...
public abstract class Policy implements Serializable, Comparable<Policy> {
	...
	public XDIArc getPolicyAddress() {
		...
		if (this.getXdiEntity() instanceof XdiEntitySingleton)
			...
			return ((XdiEntityMemberUnordered) this.getXdiEntity()).getXdiCollection().getBasearc();
		else if (this.getXdiEntity() instanceof XdiEntityMemberOrdered)
			return ((XdiEntityMemberOrdered) this.getXdiEntity()).getXdiCollection().getBasearc();
	...
	public PolicyAnd createAndPolicy(boolean singleton) {
		...
		if (singleton)
			policyAndXdiEntity = this.getXdiEntity().getXdiEntitySingleton(XdiEntitySingleton.createarc(XDIPolicyConstants.XDI_ARC_AND), true);
		else
			policyAndXdiEntity = this.getXdiEntity().getXdiEntityCollection(XdiEntityCollection.createarc(XDIPolicyConstants.XDI_ARC_AND), true).setXdiMemberUnordered(null);
	...
	public PolicyOr createOrPolicy(boolean singleton) {
		...
		if (singleton)
			policyOrXdiEntity = this.getXdiEntity().getXdiEntitySingleton(XdiEntitySingleton.createarc(XDIPolicyConstants.XDI_ARC_OR), true);
		else
			policyOrXdiEntity = this.getXdiEntity().getXdiEntityCollection(XdiEntityCollection.createarc(XDIPolicyConstants.XDI_ARC_OR), true).setXdiMemberUnordered(null);
	...
	public PolicyNot createNotPolicy(boolean singleton) {
		...
		if (singleton)
			policyNotXdiEntity = this.getXdiEntity().getXdiEntitySingleton(XdiEntitySingleton.createarc(XDIPolicyConstants.XDI_ARC_NOT), true);
		else
			policyNotXdiEntity = this.getXdiEntity().getXdiEntityCollection(XdiEntityCollection.createarc(XDIPolicyConstants.XDI_ARC_NOT), true).setXdiMemberUnordered(null);
	...
	public ReadOnlyIterator<Policy> getPolicies() {
		...
		XdiEntitySingleton policyAndEntitySingleton = this.getXdiEntity().getXdiEntitySingleton(XdiEntitySingleton.createarc(XDIPolicyConstants.XDI_ARC_AND), false);
		XdiEntitySingleton policyOrEntitySingleton = this.getXdiEntity().getXdiEntitySingleton(XdiEntitySingleton.createarc(XDIPolicyConstants.XDI_ARC_OR), false);
		XdiEntitySingleton policyNotEntitySingleton = this.getXdiEntity().getXdiEntitySingleton(XdiEntitySingleton.createarc(XDIPolicyConstants.XDI_ARC_NOT), false);
		...
		XdiEntityCollection policyAndEntityCollection = this.getXdiEntity().getXdiEntityCollection(XdiEntityCollection.createarc(XDIPolicyConstants.XDI_ARC_AND), false);
		XdiEntityCollection policyOrEntityCollection = this.getXdiEntity().getXdiEntityCollection(XdiEntityCollection.createarc(XDIPolicyConstants.XDI_ARC_OR), false);
		XdiEntityCollection policyNotEntityCollection = this.getXdiEntity().getXdiEntityCollection(XdiEntityCollection.createarc(XDIPolicyConstants.XDI_ARC_NOT), false);
