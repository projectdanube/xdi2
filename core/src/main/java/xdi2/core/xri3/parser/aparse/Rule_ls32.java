...
final public class Rule_ls32 extends Rule
{
  private Rule_ls32(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ls32 parse(ParserContext context)
  {
    ...
    rule = null;
    if (parsed)
      rule = new Rule_ls32(context.text.substring(s0, context.index), e0);
    else
      context.index = s0;
