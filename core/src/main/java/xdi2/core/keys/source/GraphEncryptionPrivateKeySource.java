 ...
 */
public class GraphEncryptionPrivateKeySource extends AbstractKeySource<PrivateKey> implements KeySource<PrivateKey> {

	private Graph privateKeyGraph;

	public GraphEncryptionPrivateKeySource(Graph privateKeyGraph) {
	...
	public GraphEncryptionPrivateKeySource() {
	...
	protected PrivateKey getKeyInternal() throws GeneralSecurityException {
		...
		PrivateKey privateKey = Keys.getEncryptionPrivateKey(this.getPrivateKeyGraph(), XDIaddress);
