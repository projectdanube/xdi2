 ...
 */
public class GraphEncryptionPublicKeySource extends AbstractKeySource<PublicKey> implements KeySource<PublicKey> {

	private Graph publicKeyGraph;

	public GraphEncryptionPublicKeySource(Graph publicKeyGraph) {
	...
	public GraphEncryptionPublicKeySource() {
	...
	protected PublicKey getKeyInternal() throws GeneralSecurityException {
		...
		PublicKey publicKey = Keys.getEncryptionPublicKey(this.getPublicKeyGraph(), XDIaddress);
