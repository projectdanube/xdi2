...
public final class XDIAuthenticationConstants {
	...
	public static final XDIAddress XDI_ADD_MSG_SIG_KEYPAIR_PUBLIC_KEY = AddressUtil.concatAddresses(XDI_ADD_MSG_SIG_KEYPAIR, XDI_ADD_PUBLIC_KEY);
	public static final XDIAddress XDI_ADD_MSG_SIG_KEYPAIR_PRIVATE_KEY = AddressUtil.concatAddresses(XDI_ADD_MSG_SIG_KEYPAIR, XDI_ADD_PRIVATE_KEY);
	public static final XDIAddress XDI_ADD_MSG_ENCRYPT_KEYPAIR = XDIAddress.create("$msg$encrypt$keypair");
	public static final XDIAddress XDI_ADD_MSG_ENCRYPT_KEYPAIR_PUBLIC_KEY = AddressUtil.concatAddresses(XDI_ADD_MSG_ENCRYPT_KEYPAIR, XDI_ADD_PUBLIC_KEY);
	public static final XDIAddress XDI_ADD_MSG_ENCRYPT_KEYPAIR_PRIVATE_KEY = AddressUtil.concatAddresses(XDI_ADD_MSG_ENCRYPT_KEYPAIR, XDI_ADD_PRIVATE_KEY);
