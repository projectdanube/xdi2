...
/**
 * Constants for XDI security.
 * 
 * @author markus
 */
public final class XDISecurityConstants {
	...
	public static final XDIArc XDI_ARC_DIGEST = XDIArc.create("$digest");
	...
	public static final XDIAddress XDI_ADD_DIGEST_VALID = XDIAddress.create("<$digest><$valid>");
