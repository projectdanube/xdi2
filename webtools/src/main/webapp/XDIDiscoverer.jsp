...
<body>
	...
	<form action="XDIDiscoverer" method="post" accept-charset="UTF-8">
		...
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.SOVRIN_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.SOVRIN_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for XDI/Sovrin.<br>
