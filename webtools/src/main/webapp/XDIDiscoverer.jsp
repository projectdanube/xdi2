...
<body>
	...
	<form action="XDIDiscoverer" method="post" accept-charset="UTF-8">
		...
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.XDI2_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.XDI2_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for XDI2 native.<br>
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.XDI2_NEUSTAR_PROD_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.XDI2_NEUSTAR_PROD_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for XDI2/Neustar PROD (default).<br>
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.XDI2_NEUSTAR_OTE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.XDI2_NEUSTAR_OTE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for XDI2/Neustar OTE.<br>
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.NEUSTAR_PROD_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.NEUSTAR_PROD_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for Neustar PROD.<br>
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.NEUSTAR_OTE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.NEUSTAR_OTE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for Neustar OTE.<br>
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.NEUSTAR_STAGE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.NEUSTAR_STAGE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for Neustar STAGE.<br>
		Use <span onclick="document.getElementById('endpoint').value='<%= xdi2.discovery.XDIDiscoveryClient.LEOLA_NYMBLE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %>'" style="font-size: 1em; font-weight: bold; cursor: pointer;"><%= xdi2.discovery.XDIDiscoveryClient.LEOLA_NYMBLE_DISCOVERY_XDI_CLIENT.getXdiEndpointUri() %></span> for Leola Group NYMBLEs.</span></td>
		</tr>
