...
public class ExpandDollarIsInterceptor extends AbstractInterceptor implements MessageEnvelopeInterceptor, OperationInterceptor {
	...
	private static final String EXECUTIONCONTEXT_KEY_EXPANDEDADDRESSES_PER_MESSAGEENVELOPE = VariablesInterceptor.class.getCanonicalName() + "#expandedaddressespermessageenvelope";
