...
public final class XDIMessagingConstants {
	...
	public static final XDIArc XDI_ARC_EC_MSG = XDIArc.create("[$msg]");
	public static final XDIArc XDI_ARC_V_MSG = XDIArc.create("{$msg}");

	public static final XDIAddress XDI_ADD_MSG = XDIAddress.fromComponent(XDI_ARC_MSG);
	public static final XDIAddress XDI_ADD_EC_MSG = XDIAddress.fromComponent(XDI_ARC_EC_MSG);
	public static final XDIAddress XDI_ADD_V_MSG = XDIAddress.fromComponent(XDI_ARC_V_MSG);
	...
	public static final XDIArc XDI_ARC_FROM = XDIArc.create("$from");
	public static final XDIArc XDI_ARC_TO = XDIArc.create("$to");
	...
	public static final XDIAddress XDI_ADD_FROM = XDIAddress.fromComponent(XDI_ARC_FROM);
	public static final XDIAddress XDI_ADD_TO = XDIAddress.fromComponent(XDI_ARC_TO);
