...
public final class XDIMessagingConstants {
	...
	public static final XDIAddress XDI_ADD_GET_BOOLEAN = AddressUtil.concatAddresses(XDI_ADD_GET, XDIDictionaryConstants.XDI_ADD_BOOLEAN);
	public static final XDIAddress XDI_ADD_GET_NUMBER = AddressUtil.concatAddresses(XDI_ADD_GET, XDIDictionaryConstants.XDI_ADD_NUMBER);
