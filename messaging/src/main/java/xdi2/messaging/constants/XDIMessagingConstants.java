...
public final class XDIMessagingConstants {
	...
	public static final XDI3Segment XRI_S_SECRET_TOKEN = XDI3Segment.create("!($secret)!<$token><<$string>>");
	public static final XDI3Segment XRI_S_OAUTH_TOKEN = XDI3Segment.create("!($oauth)!<$token><<$string>>");
