...
public class ErrorMessageResult extends MessageResult {
	...
	public static final XDIAddress XDI_ADD_ERROR = XDIAddress.create("" + XdiAttributeSingleton.createarc(XDIArc.create("$error")));
	...
	public static boolean isValid(Graph graph) {
		...
		if (XdiAbstractContext.fromContextNode(graph.getRootContextNode(false)).getXdiAttributeSingleton(XdiAttributeSingleton.createarc(XDI_ARC_FALSE), false) == null) return false;
	...
	public String getErrorString() {
		...
		XdiAttributeSingleton xdiAttributeSingleton = XdiAbstractContext.fromContextNode(this.getGraph().getRootContextNode(false)).getXdiAttributeSingleton(XdiAttributeSingleton.createarc(XDI_ARC_FALSE), false);
	...
	public void setErrorString(String errorString) {
		...
		XdiAttributeSingleton xdiAttributeSingleton = XdiAbstractContext.fromContextNode(this.getGraph().getRootContextNode(false)).getXdiAttributeSingleton(XdiAttributeSingleton.createarc(XDI_ARC_FALSE), true);
