...
public class ModOperation extends Operation {
	...
	private static final long serialVersionUID = 1540622425550398841L;
	...
	public static boolean isValid(Relation relation) {
		...
		if (XDIAddressUtil.startsWithXDIAddress(relation.getXDIAddress(), XDIMessagingConstants.XDI_ADD_MOD) == null) return false;
