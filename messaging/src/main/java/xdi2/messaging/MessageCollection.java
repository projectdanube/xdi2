...
public final class MessageCollection implements Serializable, Comparable<MessageCollection> {
	...
	public static boolean isValid(XdiEntityCollection xdiEntityCollection) {
		...
		return xdiEntityCollection.getContextNode().getArc().equals(XdiEntityCollection.createarc(XDIMessagingConstants.XDI_ARC_MSG));
	}
	...
	public XDIAddress getSenderAddress() {
		...
		return this.getSender().getAddress();
	}
