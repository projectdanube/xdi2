...
public abstract class AbstractGraphMessagingTargetTest extends TestCase {
	...
	public void testMessageEnvelope() throws Exception {
		...
		MessageEnvelope messageEnvelope1 = MessageEnvelope.fromOperationXriAndTargetStatements(XDIMessagingConstants.XDI_ADD_SET, new SingleItemIterator<XDIStatement> (XDIStatement.create("=markus/+friend/=giovanni")));
		...
		MessageEnvelope messageEnvelope2 = MessageEnvelope.fromOperationXriAndTargetAddress(XDIMessagingConstants.XDI_ADD_GET, XDIAddress.create("=markus"));
