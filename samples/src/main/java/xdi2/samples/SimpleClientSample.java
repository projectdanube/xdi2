...
public class SimpleClientSample {
    ...
    static void doAdd() throws Exception {
        ...
        message.createAddOperation(new XRI3Segment("(=markus+name/!/(data:,Markus))"));
    ...
    static void doGet() throws Exception {
        ...
        MessageEnvelope messageEnvelope = new MessageEnvelope();
        Message message = messageEnvelope.getMessage(new XRI3Segment("=sender"), true);
        message.createGetOperation(new XRI3Segment("()"));
    ...
    static void doDel() throws Exception {
        ...
        MessageEnvelope messageEnvelope = new MessageEnvelope();
        Message message = messageEnvelope.getMessage(new XRI3Segment("=sender"), true);
        message.createDelOperation(new XRI3Segment("()"));
